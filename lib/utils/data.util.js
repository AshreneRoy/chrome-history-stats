...
const convertBytesToNearestMemoryUnit = (bytes) => {
  ...
  return parseFloat((bytes / Math.pow(1024, i))).toFixed(2)+ ' ' + constants.MEMORY_SIZES[i];
}
...
export { convertToReadableTime, convertToReadableDate, convertBytesToNearestMemoryUnit, massageData };